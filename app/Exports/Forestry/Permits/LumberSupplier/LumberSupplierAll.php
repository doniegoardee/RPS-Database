...
class LumberSupplierAll implements WithMultipleSheets
{
    protected $lumbersupplier;

    public function __construct($lumbersupplier)
    {
        $this->lumbersupplier = $lumbersupplier;
    }
    ...
    public function sheets(): array
    {
        ...
        if ($this->lumbersupplier->isEmpty()) {
        ...
        $grouped = $this->lumbersupplier->groupBy(function ($item) {

...
<div class="container-fluid d-flex flex-column" style="height: 100vh; overflow: hidden;">
    ...
    <div class="flex-grow-1 overflow-auto">
        ...
        <div class="d-sm-flex align-items-center mb-4">
            ...
            <a href="{{ route('fpa.client', ['address' => $client->address]) }}" class="btn btn-sm btn-primary shadow-sm me-3">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="{{ route('delete-data.fpa',$item->id) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
                            ...
                            <div class="modal fade" id="editModal{{ $item->id }}" tabindex="-1" aria-labelledby="editModalLabel{{ $item->id }}" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('update-data.fpa',$item->id) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')

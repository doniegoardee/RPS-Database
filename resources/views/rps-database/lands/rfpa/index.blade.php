...
<div class="container-fluid d-flex flex-column" style="height: 100vh; overflow: hidden;">
    ...
    <div class="flex-grow-1 overflow-auto">
        ...
        <div class="d-sm-flex align-items-center mb-4">
            <a href="{{ route('lands') }}" class="btn btn-sm btn-primary shadow-sm me-3">
                <i class="fas fa-arrow-left fa-sm text-white-50"></i> Back
            </a>
                <h1 class="h3 mb-0 text-gray-800">RFPA (Agri. Lands)</h1>
        </div>
 ...
 --}}
  <a href="{{ route('all.lands-excel',['lands_type'=> 'RFPA']) }}" class="btn btn-sm btn-success shadow-sm">
    ...
    <div class="container-fluid px-0">
        <div class="card-body px-0">
            @foreach ($address as $add)
                    <a href="{{ route('rfpa.client', ['address' => $add->address]) }}" class="address-container">
...
{{-- <div class="modal fade" id="addFolderModal" tabindex="-1" aria-labelledby="addFolderModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('ld.folder') }}" method="POST">
                @csrf

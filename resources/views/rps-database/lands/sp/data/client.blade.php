    ...
    <div class="flex-grow-1 overflow-auto">
        ...
        <div class="mb-4">
            <div class="d-flex align-items-center mb-2">
                <a href="{{ route('SP') }}" class="btn btn-sm btn-primary shadow-sm me-3">
    ...
    @endif
        ...
        <div class="d-flex justify-content-between flex-wrap gap-2 mt-3">
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('lands-data.excel', ['address' => $add->address, 'type' => 'SP']) }}" class="btn btn-sm btn-success shadow-sm">
        ...
        <div class="container-fluid px-0">
            <div class="card-body px-0">
                @foreach ($client as $item)
                    <a href="{{ route('sp.client-data', $item->id) }}" class="d-flex align-items-center gap-3 py-3 px-4 mb-2 bg-light rounded shadow-sm text-decoration-none address-container hover-shadow">
...
<div class="modal fade" id="addClientModal" tabindex="-1" aria-labelledby="addClientModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('add-client.sp',[ 'address'=> $add->address]) }}" method="POST">
                @csrf
...
<div class="modal fade" id="ImportClientModal" tabindex="-1" aria-labelledby="ImportClientModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('lands.import',['address' => $add->address,'lands_type' => 'SP']) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="mb-3">

...
<div class="container-fluid d-flex flex-column" style="height: 100vh; overflow: hidden;">
    ...
    <div class="flex-grow-1 overflow-auto">
        ...
        <div class="d-sm-flex align-items-center mb-4">
            ...
            <a href="{{ route('foreshore.client', ['address' => $client->address]) }}" class="btn btn-sm btn-primary shadow-sm me-3">
                ...
                <table class="table table-bordered">
                    <thead class="text-center bg-primary text-white">
                        <tr>
                            ...
                            <th style="width: 10%;">FLA No.</th>
                            <th style="width: 10%;">Area</th>
                            <th style="width: 8%;">Remarks/Status</th>
                            <th>Document</th>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="{{ route('delete-data.foreshore',$item->id) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
                            ...
                            <div class="modal fade" id="editModal{{ $item->id }}" tabindex="-1" aria-labelledby="editModalLabel{{ $item->id }}" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('update-data.foreshore',$item->id) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                        ...
                                        <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    <label for="" class="form-label">FLA No.</label>
                                                    <input type="text" class="form-control" id="" name="fla_no" value="{{ old('fla_no', $item->fla_no) }}" placeholder="Enter FLA No..">
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    <label for="" class="form-label">Remarks/Status</label>
                                                    <input type="text" class="form-control" id="" name="remarks_status" value="{{ old('remarks_status', $item->remarks_status) }}" placeholder="Enter Remarks/Status..">
                                                </div>
            ...
            <form action="{{ route('foreshore-data.store',[$client->id , 'add' => $client->address]) }}" id="Client" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="" name="applicant" value="{{ old('name',$client->name) }}" placeholder="Enter Applicant..">
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="folderAddress" class="form-label">FLA No.</label>
                        <input type="text" class="form-control" id="" name="fla_no"  placeholder="Enter FLA No..">
                    </div>

                    <div class="mb-3">
                        <label for="folderAddress" class="form-label">Area</label>
                        <input type="text" class="form-control" id="" name="area" placeholder="Enter Area..">
                    </div>

                    <div class="mb-3">
                        <label for="folderAddress" class="form-label">Remarks/Status</label>

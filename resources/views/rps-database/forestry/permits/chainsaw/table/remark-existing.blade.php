...
<div class="container-fluid d-flex flex-column" style="height: 100vh; overflow: hidden;">
    ...
    <div class="flex-grow-1 overflow-auto">
        ...
        <div class="d-sm-flex align-items-center mb-4">
            <a href="{{ route('chainsaw.expired', ['add' => $client->address]) }}" class="btn btn-sm btn-primary shadow-sm me-3">
        ...
        <a href="{{ route('report.chainsaw.existing',$client->id) }}" class="btn btn-success btn-sm shadow-sm" target="_blank">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="file" class="form-control" id="document" name="document" value="{{ old('document', $item->document) }}">

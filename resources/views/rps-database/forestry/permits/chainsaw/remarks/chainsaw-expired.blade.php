...
<div class="container-fluid d-flex flex-column" style="height: 100vh; overflow: hidden;">
    ...
    @endif
        ...
        <a href="{{ route('chainsaw.remarks.expired',['add' => $add->address]) }}" class="btn btn-danger btn-sm shadow-sm" target="_blank">
                    <i class="fa-solid fa-chart-simple me-1"></i> Generate Pdf Report
        </a>

        <a href="{{ route('status.chainsaw-excel', ['add' => $add->address, 'remarks' => 'expired']) }}" class="btn btn-sm btn-success shadow-sm ms-auto">
        ...
        <div class="container-fluid px-0">
            <div class="card-body px-0">
                ...
                <a href="{{ route('table.expired', $item->id) }}" class="d-flex align-items-center gap-3 py-3 px-4 mb-2 bg-light rounded shadow-sm text-decoration-none address-container hover-shadow">

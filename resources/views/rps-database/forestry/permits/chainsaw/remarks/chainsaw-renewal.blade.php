    ...
    @endif
        ...
        <div class="container-fluid px-0">
            <div class="card-body px-0">
                ...
                <a href="{{route('table.renewal',$item->id) }}" class="d-flex align-items-center gap-3 py-3 px-4 mb-2 bg-light rounded shadow-sm text-decoration-none address-container hover-shadow">

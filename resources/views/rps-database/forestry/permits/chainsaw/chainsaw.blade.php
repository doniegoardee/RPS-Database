...
<div class="container-fluid d-flex flex-column" style="height: 100vh; overflow: hidden;">
    ...
    <div class="flex-grow-1 overflow-auto">
        ...
        <div class="d-sm-flex align-items-center mb-4">
            ...
            <h1 class="h3 mb-0 text-gray-800">Chainsaw</h1>
        </div>
        ...
        <div class="d-flex gap-2 mb-3">
            ...
            <a href="{{ route('all-data.chainsaw-excel') }}" class="btn btn-sm btn-success shadow-sm">
...
<div class="modal fade" id="addFolderModal" tabindex="-1" aria-labelledby="addFolderModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('folder.chainsaw') }}" method="POST">
                @csrf

        ...
        <div class="container-fluid px-0">
            <div class="card-body px-0">
                @foreach ($client as $item)
                    <a href="{{ route('tree-cutting.client-data', $item->id) }}" class="d-flex align-items-center gap-3 py-3 px-4 mb-2 bg-light rounded shadow-sm text-decoration-none address-container hover-shadow">
...
<div class="modal fade" id="addClientModal" tabindex="-1" aria-labelledby="addClientModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('add-client.tree-cutting',[ 'address'=> $add->address]) }}" method="POST">
                @csrf

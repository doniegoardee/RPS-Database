...
<div class="container-fluid d-flex flex-column" style="height: 100vh; overflow: hidden;">
    ...
    <div class="d-flex justify-content-between flex-wrap gap-2 mt-3">
        ...
        <a href="{{ route('lumber-dealer.template') }}" class="btn btn-sm btn-success shadow-sm ms-auto" >
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('client.lumber-dealer',['add' => $add->address]) }}" class="btn btn-danger btn-sm shadow-sm" target="_blank">
...
<div id="clientList" style="display: flex; flex-direction: column; gap: 0.5rem;">
    ...
    <a
        href="{{ route('lumber-dealer.client-data',  $item->id) }}"
        class="client-item"
        style="
            display: flex;
            align-items: center;
...
<div class="modal fade" id="addClientModal" tabindex="-1" aria-labelledby="addClientModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('add-client.lumber-dealer',[ 'address'=> $add->address]) }}" id="Client" method="POST">
                @csrf

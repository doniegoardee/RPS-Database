...
<div class="container-fluid d-flex flex-column" style="height: 100vh; overflow: hidden;">
    ...
    <div class="flex-grow-1 overflow-auto">
        ...
        <div class="mb-4">
            <div class="d-flex align-items-center mb-2">
                <a href="{{ route('ld.remark', ['add' => $add->address]) }}" class="btn btn-sm btn-primary shadow-sm me-3">
                    <i class="fas fa-arrow-left fa-sm text-white-50"></i> Back
                </a>
                <h1 class="h4 mb-0 text-gray-800"><b>{{ $add->address }}'s New Folder</b></h1>
            </div>
    ...
    @endif
        ...
        <a href="{{ route('ld.remarks.new') }}" class="btn btn-success btn-sm shadow-sm" target="_blank">
        ...
        <div class="container-fluid px-0">
            <div class="card-body px-0">
                @foreach ($client as $item)
                    <a href="{{ route('ld.table.new', $item->id) }}" class="d-flex align-items-center gap-3 py-3 px-4 mb-2 bg-light rounded shadow-sm text-decoration-none address-container hover-shadow">
...
<div class="modal fade" id="addClientModal" tabindex="-1" aria-labelledby="addClientModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('client.ld',[ 'address'=> $add->address]) }}" method="POST">
                @csrf

...
<div class="container-fluid d-flex flex-column" style="height: 100vh; overflow: hidden;">
    ...
    @endif
        ...
        <a href="{{ route('ld.remarks.expired') }}" class="btn btn-success btn-sm shadow-sm" target="_blank">
        ...
        <div class="container-fluid px-0">
            <div class="card-body px-0">
                ...
                <a href="{{ route('ld.table.expired', $item->id) }}" class="d-flex align-items-center gap-3 py-3 px-4 mb-2 bg-light rounded shadow-sm text-decoration-none address-container hover-shadow">

...
<div class="container-fluid d-flex flex-column" style="height: 100vh; overflow: hidden;">
    ...
    <div class="flex-grow-1 overflow-auto">
        ...
        <div class="mb-4">
            <div class="d-flex align-items-center mb-2">
                ...
                <h1 class="h4 mb-0 text-gray-800"><b>{{ $add->address }}'s Renewal Folder</b></h1>
            </div>
    ...
    @endif
        ...
        <a href="{{ route('ld.remarks.renewal') }}" class="btn btn-success btn-sm shadow-sm" target="_blank">
        ...
        <div class="container-fluid px-0">
            <div class="card-body px-0">
                ...
                <a href="{{route('ld.table.renewal',$item->id) }}" class="d-flex align-items-center gap-3 py-3 px-4 mb-2 bg-light rounded shadow-sm text-decoration-none address-container hover-shadow">

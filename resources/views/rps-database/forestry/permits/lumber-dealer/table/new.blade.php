...
<div class="container-fluid d-flex flex-column" style="height: 100vh; overflow: hidden;">
    ...
    <div class="flex-grow-1 overflow-auto">
        ...
        <div class="d-sm-flex align-items-center mb-4">
            <a href="{{ route('ld.new', ['add' => $client->address]) }}" class="btn btn-sm btn-primary shadow-sm me-3">
            ...
            <form action="{{ route('ld.client.info',$client->id) }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="folderAddress" name="address" value="" placeholder="Enter address..">
                    </div>

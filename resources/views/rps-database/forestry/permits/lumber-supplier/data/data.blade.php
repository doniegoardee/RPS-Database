...
<div class="container-fluid d-flex flex-column" style="height: 100vh; overflow: hidden;">
    ...
    <div class="flex-grow-1 overflow-auto">
        ...
        <div class="d-sm-flex align-items-center mb-4">
            <a href="{{ route('lumber-supplier.client',['add' => $client->address]) }}" class="btn btn-sm btn-primary shadow-sm me-3">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="{{ route('delete-data.lumber-supplier', $item->id) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')

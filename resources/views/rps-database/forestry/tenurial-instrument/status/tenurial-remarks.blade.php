...
@endif
   ...
   <div class="row">
    ...
    <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
        <a href="{{ route('tenurial.existing', ['title' => $title, 'add' => $add->address]) }}" class="text-decoration-none">
            <div class="card border-left-primary shadow-lg h-100 py-3">
                <div class="card-body">
                    ...
                    <b class="text-lg font-weight-bold text-primary text-uppercase mb-2">{{ $existing }}</b>
                </div>
            </div>
        </a>
    </div>
    ...
    <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
        <a href="{{ route('tenurial.cancelled', ['title' => $title, 'add' => $add->address]) }}" class="text-decoration-none">
            <div class="card border-left-danger shadow-lg h-100 py-3">
                <div class="card-body">
                    <div class="text-lg font-weight-bold text-danger text-uppercase mb-2">
                        Cancelled
                    </div>
                    <b class="text-lg font-weight-bold text-danger text-uppercase mb-2">{{ $cancelled }}</b>
                </div>
            </div>
        </a>
    </div>
            ...
            <form action="{{ route('ti.import', ['address' => $add->address, 'title' => $title]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <i style="color: red; font-decoration:underline ">Status can ONLY be: <b style="text-decoration: underline">NEW,EXISTING, RENEWAL, EXPIRED or CANCELLED</b></i><br>

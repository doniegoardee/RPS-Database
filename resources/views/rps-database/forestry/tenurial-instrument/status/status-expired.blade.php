    ...
    <div class="flex-grow-1 overflow-auto">
        ...
        <div class="mb-4">
            <div class="d-flex align-items-center mb-2">
                ...
                <h1 class="h4 mb-0 text-gray-800"><b>{{ $add->address }}'s Status: Expired</b></h1>
            </div>
        </div>
        ...
        <a href="{{ route('excel-status.tenurial', ['address' => $add->address, 'status' => 'expired', 'type' => $title]) }}" class="btn btn-sm btn-success shadow-sm ms-auto">

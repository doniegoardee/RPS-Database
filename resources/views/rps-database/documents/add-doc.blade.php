            ...
            <div class="card-body">
                <form action="{{ route('store.doc') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tracking_num" class="form-control" placeholder="TN xxxx xxxxx" required>
                    </div>
                    ...
                    <div class="form-group">
                        <label>Remarks</label>
                        <textarea name="remarks" class="form-control" placeholder="Enter Remarks(Optional)">{{ old('remarks') }}</textarea>
                    </div>

                    <div class="text-end">
                        <button type="submit" class="btn" style="color:white; background: rgb(63, 158, 63);">Add Document</button>
                    </div>
                </form>
